<template>
  <div class="container mx-auto flex max-w-7xl flex-wrap pb-12">
    <div class="w-full md:w-1/2 lg:w-1/4 flex flex-col mb-8 mt-4 px-3">
      <div
          ...
          <div class="flex items-center">
            <div class="flex items-center">
              <img
                ...
                src="https://picsum.photos/50/50/?people=4"
                alt="people"
              />
            </div>

            <span class="font-medium text-gray-600 font-bold leading-normal">Joanna Wu</span>
          </div>
        ...
        <div class="p-6 flex flex-col justify-between">
          <div class="flex items-center">
            <div class="flex items-center">
              <img
                class="border-gray-500 shadow border-2 w-10 h-10 rounded-full mr-3 flex-1"
                src="https://picsum.photos/50/50/?people=5"
                alt="people"
              />
            </div>
        ...
        <div class="p-6 flex flex-col justify-between">
          <div class="flex items-center">
            <div class="flex items-center">
              <img
                class="border-gray-500 shadow border-2 w-10 h-10 rounded-full mr-3 flex-1"
                src="https://picsum.photos/50/50/?people=6"
                alt="people"
              />
            </div>
