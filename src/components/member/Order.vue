            ...
            >
              ...
              >
                <div class="block rounded-t overflow-hidden text-center">
                  <div class="bg-blue-200 text-gray-500 py-1">
                    {{ item.CreateOn.slice(0,4) }}
                  </div>
                  <div class="bg-gray-200 text-gray-500">
                    {{ item.CreateOn.slice(5,7) | month }}
                  </div>
      ...
      <div class="flex container max-w-4xl mx-auto">
        <div class="w-full flex flex-col flex-wrap justify-center px-6 lg:px-0">
          ...
          <div
            ...
            class="dialog-footer"
          >
            <el-button @click=" centerVisibl = false">
              取 消
            </el-button>
            <el-button
              type="primary"
        ...
        <div class="p-12 px-22">
          ...
          <div class="md:flex mb-8">
            ...
            <div class="md:flex-1 md:pl-3">
              ...
              <p
                ...
                class="order_text"
              >
                {{ Oneorders.CreateOn.slice(0,10) }} {{ Oneorders.CreateOn.slice(14,19) }}(GTM+8)
              </p>
            </div>
          </div>
          ...
          <div class="md:flex mb-8">
            <div class="md:flex-1 md:pr-3">
              ...
              <p class="order_text">
                {{ Oneorders.DepartureTime1 }} ~ {{ Oneorders.DepartureTime2 }}
              </p>
            </div>
            <div class="md:flex-1 md:pl-3">
          ...
          <div class="mb-8">
            <fieldset class="border-0">
              ...
              >
                <button
                  class="bg-blue-500"
                  :class="{'hidden' : !Oneorders['Act']}"
                >
                  冒險
                </button>
                <button
                  class="bg-blue-500"
                  :class="{'hidden' : !Oneorders['Secret']}"
                >
                  秘境
                </button>
                <button
                  class="bg-blue-500"
                  :class="{'hidden' : !Oneorders['Culture']}"
                >
                  文化
                </button>
                ...
                <button
                  class="bg-blue-600"
                  :class="{'hidden' : !Oneorders['Religion']}"
                >
                  宗教
                </button>
                <button
                  class="bg-blue-600"
                  :class="{'hidden' : !Oneorders['Shopping']}"
                >
                  購物
                </button>
                <button
                  class="bg-blue-600"
                  :class="{'hidden' : !Oneorders['Food']}"
                >
                  吃貨
                </button>
              </div>
              ...
              <ValidationObserver>
                ...
                <div class="mb-5">
                  ...
                  <div
                    ...
                    class="dialog-footer"
                  >
                    <el-button @click=" commentVisible = false">
                      取 消
                    </el-button>
                    <el-button
                      type="primary"
                      @click="singleRating(comment.id)"
                    >
                      送出
                    </el-button>
                  </div>
