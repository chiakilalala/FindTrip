<template>
       <div class="flex container  max-w-4xl  mx-auto  bg-chiaki-blue">
                            ...
                            <div class="w-full flex flex-wrap">
                                ...
                                <div class="w-full flex-1 mt-8">
                                    ...
                                    <div class="mx-auto max-w-xs mb-2">
                                        <input autocomplete="off" class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" 
                                        type="email" placeholder="Email"  v-model="user.loginName"/>
                                        <input autocomplete="off" class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="password" placeholder="Password" 
                                        ...
                                        <button class="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                                            ...
                                            <div class="text-xs text-gray-600  mt-5 flex justify-between">
...
export default {
  data() {
    return {
      ...
      userToken: "",
      rules: {
        loginName: [{ required: true, message: " 請輸入使用者名稱" }],
  ...
  methods: {
    ...
    login() {
      if (this.user.loginName === "" || this.user.password === "") {
        ...
        axios({
          methods: "post",
          url: "forlife.southeastasia.cloudapp.azure.com/api/ApiMembers",
          params: {
